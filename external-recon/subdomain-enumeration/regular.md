...
amass enum -passive -d $DOMAIN -silent -timeout 30 -o amass.txt
...
gitlab-subdomains -d $DOMAIN -t $(cat $GITLAB_TOKENS) &>/dev/null &&
    mv $DOMAIN.txt gitlab-subdomains.txt

# https://github.com/projectdiscovery/subfinder
subfinder -d $DOMAIN -all -o subfinder.txt &>/dev/null
```
